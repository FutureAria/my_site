                ...
                {sendError && (
                  <div className="rounded-xl border border-red-400/20 bg-red-500/10 p-4 text-sm text-red-100">
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex max-w-full items-center gap-2 rounded-lg border border-red-300/20 bg-white/10 px-3 py-2 font-semibold text-white transition-colors hover:bg-white/15"
                    >
